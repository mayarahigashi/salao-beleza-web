                ...
                <ul id="slide-out" class="side-nav leftside-navigation">
                    ...
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-communication-contacts"></i> Clientes</a>
                            ...
                            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-image-timer-auto"></i> Profissionais</a>
                                <div class="collapsible-body">
                                    <ul>
              ...
              <div class="row">
                <div class="col s12 m4 l3">
                  <div id='external-events'>    
                    <h4 class="header">Serviços</h4>
                    <div class='fc-event cyan'>Cabelo</div>
                    <div class='fc-event teal'>Mão</div>
                    <div class='fc-event cyan darken-1'>Pé</div>
