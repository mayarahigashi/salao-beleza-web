...
<body>
            ...
            <nav class="pink darken-3">
                <div class="nav-wrapper">
                    <ul class="left">                                            
                      ...
                      <li><h1 class="logo-wrapper"><a href="index.jsp" class="brand-logo darken-1"></a><span style="color: white;" class="logo-text">Materialize</span></h1></li>
                    </ul>
        ...
        <div class="wrapper">
            ...
            <aside id="left-sidebar-nav">
                <ul id="slide-out" class="side-nav leftside-navigation">
                    ...
                    <li class="bold active"><a href="index.jsp" class="waves-effect waves-cyan"><i class="mdi-action-dashboard"></i> Dashboard</a>
                    </li>
                    <li class="bold"><a href="agenda.jsp" class="waves-effect waves-cyan"><i class="mdi-editor-insert-invitation"></i> Agenda</a>
                    </li>
                    <li class="no-padding">
                        <ul class="collapsible collapsible-accordion">
                            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i> Clientes</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="css-typography.html">Lista de Clientes</a>
                                        </li>                                        
                                        <li><a href="css-icons.html">Cadastrar Clientes</a>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li class="bold"><a class="collapsible-header waves-effect waves-cyan"><i class="mdi-action-invert-colors"></i> Profissionais</a>
                                <div class="collapsible-body">
                                    <ul>
                                        <li><a href="css-typography.html">Lista de Profissionais</a>
                                        </li>                                        
                            ...
                            <li><a href="#"><i class="mdi-hardware-keyboard-tab"></i> Sair</a></li>
	          	...
	          	<div class="container">
	            	<div class="row">
	              		<div class="col s12 m12 l12">
	                		<h5 class="breadcrumbs-title">LISTA DE PROFISSIONAIS</h5>
	                		<ol class="breadcrumb">
    ...
    <footer class="page-footer pink darken-3">
        <div class="footer-copyright">
            <div class="container">
                <span class="right"> Desenvolvido por <a class="grey-text text-lighten-4" href="http://geekslabs.com/">Salão de Beleza</a></span>
            </div>
        </div>
    </footer>
    <!-- END FOOTER -->
